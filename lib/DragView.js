...
const RNDragViewNative = requireNativeComponent("RNDragView", null);
...
export default function RNDragView(props: Props) {
  ...
  let { children, dragItem, dragItems, ...rest } = props;
  ...
  return (
    <RNDragViewNative {...rest} dragItems={dragItems}>
      {children}
    </RNDragViewNative>
  );
}
